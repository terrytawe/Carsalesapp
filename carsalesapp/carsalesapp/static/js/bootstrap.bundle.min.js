  ...
  const He = {
    ...
    fn: function (t) {
      ...
      if (o && r) {
        var h = (function (t, e) {
            return Me(
              "number" != typeof (t = "function" == typeof t ? t(Object.assign({}, e.rects, { placement: e.placement })) : t) ? t : Fe(t, Yt)
            );
          })(s.padding, i),
          d = xe(o),
          u = "y" === l ? qt : Qt,
      ...
      w = (function (t, e, i, n) {
        var s =
          ...
          a = o.reduce(function (e, i) {
            var s = ii(t, i, n);
            return (
              (e.top = we(s.top, e.top)), (e.right = Ae(s.right, e.right)), (e.bottom = Ae(s.bottom, e.bottom)), (e.left = we(s.left, e.left)), e
            );
          }, ii(t, r, n));
        ...
        for (
          var s = i.mainAxis,
            ...
            v = [g].concat(b).reduce(function (t, i) {
              return t.concat(
                ye(i) === Xt ? oi(e, { placement: i, boundary: h, rootBoundary: d, padding: c, flipVariations: p, allowedAutoPlacements: m }) : i
              );
            }, []),
            y = e.rects.reference,
            w = e.rects.popper,
    ...
    _getTemplateFactory(t) {
      return (
        this._templateFactory
          ...
          : (this._templateFactory = new ts({ ...this._config, content: t, extraClass: this._resolvePossibleFunction(this._config.customClass) })),
        this._templateFactory
      );
    }
